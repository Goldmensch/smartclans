...
import de.goldmensch.smartclans.data.repositories.Repository;
...
public interface PlayerRepository extends Repository<UUID, Player> {
    List<Player> getALl(Clan clan);

    Optional<Player> read(String name);
}
